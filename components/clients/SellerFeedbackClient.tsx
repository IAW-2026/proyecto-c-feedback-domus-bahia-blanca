          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-domus-text-soft mt-2 text-lg">
                Opiniones verificadas de visitantes.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-[260px_1fr] gap-8">
                ...
                <div className="flex flex-col justify-center gap-4">
                  ...
                  {[5,4,3,2,1].map((n) => {
                    ...
                    const count =
                      ratingStats.counts[n as keyof typeof ratingStats.counts];
            ...
            <div className="mt-8 rounded-2xl bg-domus-secondary/30 border border-domus-secondary px-5 py-4 flex items-center gap-3 text-sm text-domus-text-soft">
              ...
              <p>
                Todas las reseñas son de visitas verificadas.
                Nos esforzamos por mantener transparencia y confianza.
              </p>
            </div>
